...
//    }
//    
//    public static boolean sendTransactionEmail(String toEmail, String fullName, String phone, double money, String ma) {
//    try {
//        Properties props = new Properties();
//        props.put("mail.smtp.auth", "true");
//        props.put("mail.smtp.starttls.enable", "true");
...
//        message.setFrom(new InternetAddress(EMAIL_USERNAME));
//        message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
//        message.setSubject("Thông tin giao dịch của bạn");
//
//        String htmlContent = "<h2>Xin chào " + fullName + "</h2>"
//            + "<p>Số điện thoại: <strong>" + phone + "</strong></p>"
//            + "<p>Số tiền giao dịch: <strong>" + money + " VNĐ</strong></p>"
//            + "<p>Mã giao dịch: <strong>" + ma + "</strong></p>"
